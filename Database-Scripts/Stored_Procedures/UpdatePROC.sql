CREATE OR REPLACE PROCEDURE ADMIN.UpdatePROC (
    id_Occurrence IN NUMBER,
    taxon IN VARCHAR2,
    note IN VARCHAR2
)
IS
...
BEGIN
    ...
    UPDATE OCCURRENCE O
    SET 
    	O.Kingdom = name_Kingdom,
    	O.Phylum = name_Phylum,
    	O.Class = name_Class,
    	O.Order_ = name_Order_,
    	O.Family = name_Family,
    	O.Genus = name_Genus,
    	O.Species = name_Species,
    	O.Common_name = common_name
    WHERE O.id_Occurrence = id_Occurrence;
